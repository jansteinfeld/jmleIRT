...
// biasCorrectionJMLE
void biasCorrectionJMLE(NumericVector& theta, NumericVector& beta, const NumericMatrix& X, int N, int I, int T);
RcppExport SEXP _jmleIRT_biasCorrectionJMLE(SEXP thetaSEXP, SEXP betaSEXP, SEXP XSEXP, SEXP NSEXP, SEXP ISEXP, SEXP TSEXP) {
BEGIN_RCPP
    ...
    biasCorrectionJMLE(theta, beta, X, N, I, T);
    return R_NilValue;
END_RCPP
}
// estimate_wle
...
static const R_CallMethodDef CallEntries[] = {
    {"_jmleIRT_biasCorrectionJMLE", (DL_FUNC) &_jmleIRT_biasCorrectionJMLE, 6},
